...
contract mult_QoEEvaluatorITEMS is SepoliaZamaFHEVMConfig {
    struct QoEData {
        euint8 qosType;
        euint8 qodModel;
        euint8 qodOSVersion;
    ...
    function addData(
        ...
        // Update all totals
        totalMOS = TFHE.mul(totalMOS, TFHE.asEuint32(mosValue));
        totalQosType = TFHE.mul(totalQosType, TFHE.asEuint32(qosTypeValue));
        totalQodModel = TFHE.mul(totalQodModel, TFHE.asEuint32(qodModelValue));
        totalQodOSVersion = TFHE.mul(totalQodOSVersion, TFHE.asEuint32(qodOSVersionValue));
        totalQosOperator = TFHE.mul(totalQosOperator, TFHE.asEuint32(qosOperatorValue));
