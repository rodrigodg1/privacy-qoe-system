...
const asyncDecrypt_1 = require("../asyncDecrypt");
...
describe("TestAsyncDecrypt", function () {
    before(async function () {
        ...
        await (0, asyncDecrypt_1.initGateway)();
    });
    beforeEach(async function () {
        const contractFactory = await hardhat_1.ethers.getContractFactory("TestAsyncDecrypt");
    ...
    it("test async decrypt bool", async function () {
        ...
        await tx2.wait();
        await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
        const y = await this.contract.yBool();
        (0, chai_1.expect)(y).to.equal(true);
    });
    ...
    it("test async decrypt bool would fail if maxTimestamp is above 1 day", async function () {
        await (0, chai_1.expect)(this.contract.connect(this.signers.carol).requestBoolAboveDelay()).to.be.revertedWith("maxTimestamp exceeded MAX_DELAY");
    });
    ...
    it("test async decrypt uint64", async function () {
        ...
        (0, chai_1.expect)(y).to.equal(18446744073709551600n);
    });
    it("test async decrypt uint128", async function () {
        ...
        (0, chai_1.expect)(y).to.equal(1267650600228229401496703205443n);
    });
    it("test async decrypt uint128 non-trivial", async function () {
        ...
        await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
        const y = await this.contract.yUint128();
        (0, chai_1.expect)(y).to.equal(184467440737095500429401496n);
    });
    it("test async decrypt uint256", async function () {
        ...
        (0, chai_1.expect)(y).to.equal(27606985387162255149739023449108101809804435888681546220650096895197251n);
    });
    it("test async decrypt uint256 non-trivial", async function () {
        ...
        await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
        const y = await this.contract.yUint256();
        (0, chai_1.expect)(y).to.equal(6985387162255149739023449108101809804435888681546n);
    });
    it("test async decrypt address", async function () {
        ...
        (0, chai_1.expect)(y).to.equal("0x8ba1f109551bD432803012645Ac136ddd64DBA72");
    });
    it("test async decrypt several addresses", async function () {
        ...
        (0, chai_1.expect)(y).to.equal("0x8ba1f109551bD432803012645Ac136ddd64DBA72");
        (0, chai_1.expect)(y2).to.equal("0xf48b8840387ba3809DAE990c930F3b4766A86ca3");
    });
    it("test async decrypt mixed", async function () {
        ...
        (0, chai_1.expect)(yB).to.equal(true);
        ...
        (0, chai_1.expect)(yAdd).to.equal("0x8ba1f109551bD432803012645Ac136ddd64DBA72");
    ...
    it("test async decrypt uint64 non-trivial", async function () {
        ...
        await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
        const y = await this.contract.yUint64();
        (0, chai_1.expect)(y).to.equal(18446744073709550042n);
    });
    it("test async decrypt ebytes64 trivial", async function () {
        ...
        (0, chai_1.expect)(y).to.equal(hardhat_1.ethers.toBeHex(BigInt("0x78685689"), 64));
    });
    it("test async decrypt ebytes64 non-trivial", async function () {
        const inputAlice = this.fhevm.createEncryptedInput(this.contractAddress, this.signers.alice.address);
        inputAlice.addBytes64((0, utils_1.bigIntToBytes64)(98870780878070870878787887072921111299111111000000292928818818818818221112111n));
        const encryptedAmount = await inputAlice.encrypt();
        const tx = await this.contract.requestEbytes64NonTrivial(encryptedAmount.handles[0], encryptedAmount.inputProof);
        await tx.wait();
        await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
        const y = await this.contract.yBytes64();
        (0, chai_1.expect)(y).to.equal(hardhat_1.ethers.toBeHex(98870780878070870878787887072921111299111111000000292928818818818818221112111n, 64));
    });
    it("test async decrypt ebytes128 trivial", async function () {
        const tx = await this.contract.requestEbytes128Trivial("0x8701d11594415047dfac2d9cb87e6631df5a735a2f364fba1511fa7b812dfad2972b809b80ff25ec19591a598081af357cba384cf5aa8e085678ff70bc55faee");
        await tx.wait();
        await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
        const y = await this.contract.yBytes128();
        (0, chai_1.expect)(y).to.equal(hardhat_1.ethers.toBeHex(BigInt("0x8701d11594415047dfac2d9cb87e6631df5a735a2f364fba1511fa7b812dfad2972b809b80ff25ec19591a598081af357cba384cf5aa8e085678ff70bc55faee"), 128));
    });
    it("test async decrypt ebytes128 non-trivial", async function () {
        const inputAlice = this.fhevm.createEncryptedInput(this.contractAddress, this.signers.alice.address);
        inputAlice.addBytes128((0, utils_1.bigIntToBytes128)(9887078087807087087878788707292111129911111100000029292881881881881822111211198870780878070870878787887072921111299111111000000292928818818818818221112111n));
        const encryptedAmount = await inputAlice.encrypt();
        const tx = await this.contract.requestEbytes128NonTrivial(encryptedAmount.handles[0], encryptedAmount.inputProof);
        await tx.wait();
        await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
        const y = await this.contract.yBytes128();
        (0, chai_1.expect)(y).to.equal(hardhat_1.ethers.toBeHex(9887078087807087087878788707292111129911111100000029292881881881881822111211198870780878070870878787887072921111299111111000000292928818818818818221112111n, 128));
    });
    it("test async decrypt ebytes256 trivial", async function () {
        ...
        (0, chai_1.expect)(y).to.equal(hardhat_1.ethers.toBeHex(BigInt("0x78685689"), 256));
    });
    it("test async decrypt ebytes256 non-trivial", async function () {
        const inputAlice = this.fhevm.createEncryptedInput(this.contractAddress, this.signers.alice.address);
        inputAlice.addBytes256((0, utils_1.bigIntToBytes256)(18446744073709550022n));
        const encryptedAmount = await inputAlice.encrypt();
        const tx = await this.contract.requestEbytes256NonTrivial(encryptedAmount.handles[0], encryptedAmount.inputProof);
        await tx.wait();
        await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
        const y = await this.contract.yBytes256();
        (0, chai_1.expect)(y).to.equal(hardhat_1.ethers.toBeHex(18446744073709550022n, 256));
    });
    it("test async decrypt ebytes256 non-trivial with snapshot [skip-on-coverage]", async function () {
        if (hardhat_1.network.name === "hardhat") {
            this.snapshotId = await hardhat_1.ethers.provider.send("evm_snapshot");
            const inputAlice = this.fhevm.createEncryptedInput(this.contractAddress, this.signers.alice.address);
            inputAlice.addBytes256((0, utils_1.bigIntToBytes256)(18446744073709550022n));
            const encryptedAmount = await inputAlice.encrypt();
            const tx = await this.contract.requestEbytes256NonTrivial(encryptedAmount.handles[0], encryptedAmount.inputProof);
            ...
            const y = await this.contract.yBytes256();
            (0, chai_1.expect)(y).to.equal(hardhat_1.ethers.toBeHex(18446744073709550022n, 256));
            await hardhat_1.ethers.provider.send("evm_revert", [this.snapshotId]);
            const inputAlice2 = this.fhevm.createEncryptedInput(this.contractAddress, this.signers.alice.address);
            inputAlice2.addBytes256((0, utils_1.bigIntToBytes256)(424242n));
            const encryptedAmount2 = await inputAlice2.encrypt();
            const tx2 = await this.contract.requestEbytes256NonTrivial(encryptedAmount2.handles[0], encryptedAmount2.inputProof);
            await tx2.wait();
            await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
            const y2 = await this.contract.yBytes256();
            (0, chai_1.expect)(y2).to.equal(hardhat_1.ethers.toBeHex(424242n, 256));
        }
    });
    it("test async decrypt mixed with ebytes256", async function () {
        const inputAlice = this.fhevm.createEncryptedInput(this.contractAddress, this.signers.alice.address);
        inputAlice.addBytes256((0, utils_1.bigIntToBytes256)(18446744073709550032n));
        const encryptedAmount = await inputAlice.encrypt();
        const tx = await this.contract.requestMixedBytes256(encryptedAmount.handles[0], encryptedAmount.inputProof);
        await tx.wait();
        await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
        const y = await this.contract.yBytes256();
        (0, chai_1.expect)(y).to.equal(hardhat_1.ethers.toBeHex(18446744073709550032n, 256));
        const y2 = await this.contract.yBytes64();
        (0, chai_1.expect)(y2).to.equal(hardhat_1.ethers.toBeHex(BigInt("0xaaff42"), 64));
        const yb = await this.contract.yBool();
        (0, chai_1.expect)(yb).to.equal(true);
        const yAdd = await this.contract.yAddress();
        (0, chai_1.expect)(yAdd).to.equal("0x8ba1f109551bD432803012645Ac136ddd64DBA72");
    ...
    it("test async decrypt ebytes256 non-trivial trustless", async function () {
        ...
        inputAlice.addBytes256((0, utils_1.bigIntToBytes256)(18446744073709550022n));
        const encryptedAmount = await inputAlice.encrypt();
        const tx = await this.contract.requestEbytes256NonTrivialTrustless(encryptedAmount.handles[0], encryptedAmount.inputProof);
        await tx.wait();
        await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
        const y = await this.contract.yBytes256();
        (0, chai_1.expect)(y).to.equal(hardhat_1.ethers.toBeHex(18446744073709550022n, 256));
    ...
    it("test async decrypt mixed with ebytes256 trustless", async function () {
        ...
        inputAlice.addBytes256((0, utils_1.bigIntToBytes256)(18446744073709550032n));
        const encryptedAmount = await inputAlice.encrypt();
        const tx = await this.contract.requestMixedBytes256Trustless(encryptedAmount.handles[0], encryptedAmount.inputProof);
        await tx.wait();
        await (0, asyncDecrypt_1.awaitAllDecryptionResults)();
        const y = await this.contract.yBytes256();
        (0, chai_1.expect)(y).to.equal(hardhat_1.ethers.toBeHex(18446744073709550032n, 256));
...
//# sourceMappingURL=testAsyncDecrypt.js.map